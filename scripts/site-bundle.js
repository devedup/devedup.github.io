!function(e) {
    ...
    YUI.add("squarespace-dynamic-data", function(e) {
        e.namespace("Squarespace"), e.Squarespace.DynamicData = function(a) {
            ...
            function n() {
                ...
                f && e && (e = e.replace("#", ""), e = e.endsWith("/") ? e : e + "/", l(null, e))
            }
            function r(e) {
                "function" == typeof e && e()
            }
            ...
            function l(a, t) {
                var n,
                    l,
                    s = t && e.one(b.search + '[href="' + t + '"]') || a && a.currentTarget || null,
                    g = t || s && s.getAttribute("href");
                if (a && a.preventDefault(), h && (window.location.hash = g), s && !y && i(g) != u.getAttribute(b.activeWrapper) || s && y && !u.one("[" + b.activeWrapper + "=" + i(g) + "]")) {
                    o.Lifecycle.destroy(), u.setAttribute(b.activeWrapper, i(g)), e.all("." + b.active).removeClass(b.active), s.addClass(b.active), u.removeClass(b.ready), u.addClass(b.loading), t || c(), r(p), y && (n = e.Node.create("<div></div>"), n.addClass(b.appendWrapper), n.setAttribute(b.activeWrapper, i(g)), n.appendTo(u)), l = n ? n : u;
                    var f = e.one("body"),
                    ...
                    f.addClass("index-loading"), l.load(g, v, function() {
                        m.destroy(), f.removeClass("index-loading"), d(g)
                    })
                } else
                    u.setAttribute(b.activeWrapper, i(g)), t || c()
            }
            function s(a) {
            ...
            function d(e) {
                s(g), u.removeClass(b.loading), u.addClass(b.ready)
            }
            var u = a && a.wrapper || "body",
                p = a && a.preCallback || null,
                g = a && a.postCallback || null,
                h = a && a.useHashes || !1,
                f = a && a.autoOpenHash || !1,
                v = a && a.injectEl || null,
    ...
    a.default = t, e.exports = a.default
}, function(e, a) {
    "use strict";
    Object.defineProperty(a, "__esModule", {
        value: !0
    ...
    var t = Static.SQUARESPACE_CONTEXT.authenticatedAccount,
        o = {
            all: {
                callbacks: []
            }
            ...
            watch: function() {
                ...
                if (t) {
                    ...
                    if ("string" == typeof arguments[0] && "function" == typeof arguments[1]) {
                        ...
                        o[a] || (o[a] = {
                            callbacks: []
                        }), o[a].callbacks.push(arguments[1])
                    } else
                        arguments[0].constructor === Array && "function" == typeof arguments[1] && arguments[0].forEach(function(a) {
                            o[a] || (o[a] = {
                                callbacks: []
                            }), o[a].callbacks.push(e[1])
                        })
                }
            }
        };
    t && window.Y && window.Y.Global && window.Y.Global.on("tweak:change", function(e) {
        var a = e.getName(),
            t = {
                name: a,
                value: e.config && e.config.value || e.value
            };
        o[a] && o[a].callbacks.forEach(function(e) {
            try {
                e(t)
            } catch (e) {
                console.error(e)
    ...
    var t = "UserAccounts API not available",
        o = window.UserAccountApi,
        n = function() {
            console.warn(t)
        },
        r = o ? o.isUserAuthenticated : n,
        i = o ? o.openAccountScreen : n;
    a.default = {
    ...
    Y.use(["node", "squarespace-dynamic-data", "squarespace-gallery-ng", "history-hash", "squarespace-util"], function(e) {
        function a() {
            if (window.location.hash && "#" != window.location.hash) {
                ...
                if (!n)
                    return;
                if (n.hasAttribute("data-type-protected") || !n.hasClass("page-project") && !n.hasClass("gallery-project"))
                ...
                e.one("#page").removeClass("page-open"), e.one("body").removeClass("index-page-open"), t(), e.all("div.active-project").removeClass("active-project")
        }
        function t() {
        ...
        function n() {
            ...
            var n,
                r = function(a) {
                    if (n && n.destroy(), "Autocolumns" != e.Squarespace.Template.getTweakValue("thumbnail-layout"))
                        a && e.all(".project").each(function(e) {
        ...
        function i(a) {
            ...
            new e.Anim({
                node: e.one(document.scrollingElement || t),
                to: {
                    scroll: [0, 0]
                },
                duration: .2,
                ...
                0 != e.one(t).get("scrollTop") && e.one(t).set("scrollTop", 0), a && a()
            })
        }
        function l(a, t) {
            var o;
        ...
        e.on("domready", function() {
            function t() {
                b.hasClass("logo-image") && S < 750 && c.one("img").get("offsetWidth") > c.one("img").get("offsetHeight") ? c.addClass("landscape") : c.removeClass("landscape")
            }
            function o() {
                var a;
            ...
            }), b = e.one("body"), S = parseInt(b.getComputedStyle("width"), 10), e.one("body").hasClass("layout-style-center") && e.all("#topNav .subnav").each(function(e) {
            ...
            if (e.one("body").hasClass("collection-type-gallery"))
                if (S < 750)
                    e.all("img[data-src]").each(function(a, t) {
                    ...
                    var g = e.one("body").get("winHeight"),
                        h = 2 * parseInt(e.Squarespace.Template.getTweakValue("pagePadding"), 10),
                        f = 2 * parseInt(e.Squarespace.Template.getTweakValue("outerPadding"), 10) + 2 * parseInt(e.Squarespace.Template.getTweakValue("topPadding"), 10),
                        v = parseInt(e.one("#footer").get("offsetHeight"), 10),
                        m = e.one("#slideshowWrapper").getY(),
                        w = m + h + v + f;
                    g - w > 500 ? e.one("#slideshowWrapper").setStyle("height", g - w) : e.one("#slideshowWrapper").setStyle("height", "500px"), e.one("window").on("resize", function(a) {
                        g = e.one("body").get("winHeight"), g - w > 500 ? e.one("#slideshowWrapper").setStyle("height", g - w) : e.one("#slideshowWrapper").setStyle("height", "500px"), y.refresh()
                    });
            ...
            var C = e.one("#footer a[href=http://www.squarespace.com]");
            C && C.set("href", "http://www.squarespace.com?channel=word_of_mouth&subchannel=customer&source=footer&campaign=" + Static.SQUARESPACE_CONTEXT.website.id)
        });
        var s = {};
        l(function() {
